...
public class AppTest {
    ...
    @Order(3)
    void stateRecovery() {
        /* Teste responsável para verificar se o MessageServer recupera o seu Banco de Dados em memória, através do Log */
    ...
    @Order(4)
    void executionOrder() {
        /* Teste responsável para verificar se o MessageServer está adicionando as mensagens na ordem correta */
